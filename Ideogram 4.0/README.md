# ApoGalleria — Visual Aesthetics Libraries
...
- Captioned using my **ApoStudio** nodes and custom system prompts, built specifically for Ideogram 4's structured JSON format.
