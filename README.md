...
- **50,000+ Image [.jpg] & [.txt] json caption pairs** — the image is a visual reference only; the caption is the product. The exact caption format (structured Ideo4 JSON).
