...
4. Place the [Sample Dataset](https://github.com/ApoloniArt/Visual-Aesthetics-Library/tree/main/SampleDataset) inside ApoGalleria's **Library** folder located within the node directory [rename to have NO spaces], this will allow you to test the captions and functionality before committing to my behemoth👇
